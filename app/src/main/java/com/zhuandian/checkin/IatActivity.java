...
public class IatActivity extends Activity implements OnClickListener {
    ...
    private void printResult(RecognizerResult results) {
        ...
        sharedPreferences.edit().putString("password", resultBuffer.toString()).commit();

        new AlertDialog.Builder(this)
                .setTitle("设置成功")
                .setMessage("密码设置成功，点击返回上一页")
    ...
    private void executeStream() {
        ...
        if (ret != ErrorCode.SUCCESS) {
            ...
            byte[] audioData = FucUtil.readAudioFile(IatActivity.this, "iattest.wav");
